...
import com.antiaction.common.datastructures.flatfilelookup.FlatfileLookup;
import com.antiaction.common.datastructures.flatfilelookup.FlatfileLookupAbstract;

@RunWith(JUnit4.class)
public class TestFlatfileLookup {
	...
	public void test_flatfilelookup() {
		...
		FlatfileLookupAbstract ffl = new FlatfileLookup( indexFile, 4, 16 );
		boolean bOpened;
		long index;
		String tmpStr;
